...
################################################################################
## Form generated from reading UI file 'LandingPageyoQFgn.ui'
##
...
"color:rgb(0,0,0);\n"
"}")
        self.gss_btn = QPushButton(self.centralwidget)
        self.gss_btn.setObjectName(u"gss_btn")
        self.gss_btn.setGeometry(QRect(250, 260, 261, 41))
        self.gss_btn.setStyleSheet(u"QPushButton {\n"
"background-color: rgb(237, 188, 160);\n"
"font: italic 10pt \"Goudy Old Style\";\n"
"	\n"
"color: rgb(0,0,0);\n"
...
"}")
        ...
        self.drone_btn.setGeometry(QRect(250, 320, 261, 41))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gss_btn.setText(QCoreApplication.translate("MainWindow", u"GSS", None))
